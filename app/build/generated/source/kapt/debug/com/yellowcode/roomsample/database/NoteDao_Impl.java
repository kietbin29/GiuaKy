  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `note_table`(`id`,`name`,`email`,`contact`,`addredd`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Note value) {
        ...
        if (value.getContacts() == null) {
          ...
          stmt.bindString(4, value.getContacts());
        }
    ...
    return CoroutinesRoom.execute(__db, false, new Callable<List<Note>>() {
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfContacts = CursorUtil.getColumnIndexOrThrow(_cursor, "contact");
          final int _cursorIndexOfContent = CursorUtil.getColumnIndexOrThrow(_cursor, "addredd");
          ...
          while(_cursor.moveToNext()) {
            ...
            final String _tmpContacts;
            _tmpContacts = _cursor.getString(_cursorIndexOfContacts);
            final String _tmpContent;
            _tmpContent = _cursor.getString(_cursorIndexOfContent);
            _item = new Note(_tmpId,_tmpTitle,_tmpEmail,_tmpContacts,_tmpContent);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final String _tmpContent;
            _tmpContent = _cursor.getString(_cursorIndexOfContent);
            _result = new Note(_tmpId,_tmpTitle,_tmpEmail,_tmpContacts,_tmpContent);
          } else {
            _result = null;
          }
          return _result;
