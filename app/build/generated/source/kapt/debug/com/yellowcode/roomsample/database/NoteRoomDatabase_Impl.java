  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `note_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `email` TEXT NOT NULL, `contact` TEXT NOT NULL, `addredd` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"78a8769e6cff7d3255dd525ac327669f\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsNoteTable.put("name", new TableInfo.Column("name", "TEXT", true, 0));
        ...
        _columnsNoteTable.put("addredd", new TableInfo.Column("addredd", "TEXT", true, 0));
    ...
    }, "78a8769e6cff7d3255dd525ac327669f", "a4f3fba3e69063da72cdadb59f9904b0");
